...
@section('content')
	...
	{!!ContentHelper::openCont('carded2' , 'icon-document', 'Print Preview' , '', '', '', route('admin.dv.index'), route('admin.dv.edit', $dv->slug), route('admin.dv.create') )!!}
		{!!ContentHelper::openCard('carded', 'dv-myList')!!}	
